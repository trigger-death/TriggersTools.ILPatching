...
namespace TriggersTools.ILPatching.RegularExpressions {
	partial class ILPatternBuilder {
		#region ToString
		...
		public override string ToString() {
			return ToString(ILPattern.DefaultToStringFormat, CultureInfo.CurrentCulture);
		}
		/// <summary>
		...
		public string ToString(string format, IFormatProvider formatProvider) {
			return ILPattern.ToString(checks, format, formatProvider);
		}
		...
		/// </exception>
		public void Print() {
			Print(ILPattern.DefaultPrintFormat, CultureInfo.CurrentCulture);
		}
		/// <summary>
		...
		public void Print(string format, IFormatProvider formatProvider) {
			ILPattern.Print(checks, format, formatProvider);
		}
